...
public:
  ...
  void show() const {
    display();
    cout << "Specialization: Developer, Programming Language: "
...
public:
  ...
  void leadTeam() const {
    cout << "Team Lead leading a team of " << teamSize << " members."
              << endl;
  }
};
...
public:
  TechLead(const string &empName, int empId, const string &project,
           int teamSize)
...
public:
  MarketingManager(const string &empName, int empId)
...
class BusinessDevelopmentManager : public MarketingManager,
                                   public SalesManager {
public:
  ...
  void coordinateBusinessDevelopment() const {
    ...
    boostSales();
    cout << "Business Development Manager coordinating business "
                 "development efforts."
              << endl;
  }
};
